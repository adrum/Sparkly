...
actor BuildCache {
    ...
    init(
        ...
        if let cacheDirectory {
            ...
            self.cacheDirectory = cachesDir.appendingPathComponent("Sparkley", isDirectory: true)
        }
        self.policy = policy
    ...
    func store(_ tempURL: URL, for item: AppcastItem, app: AppEntry) async throws -> URL {
        ...
        do {
            ...
            throw SparkleyError.cacheStoreFailed(underlying: error)
        }
    }
    ...
    func clearCache() async throws {
        do {
            ...
            throw SparkleyError.cacheEvictionFailed(underlying: error)
        }
    }
