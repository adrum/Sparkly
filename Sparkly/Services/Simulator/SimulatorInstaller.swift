...
actor SimulatorInstaller {
    ...
    func install(
        ...
        guard app.platform == .ios else {
            throw SparklyError.unsupportedPlatform(app.platform)
        }
    ...
    private func extractZip(_ zipPath: URL) async throws -> URL {
        ...
        do {
            ...
            throw SparklyError.extractionFailed(zipPath, underlying: error)
        }
    ...
    private func findAppBundle(in directory: URL) throws -> URL {
        ...
        throw SparklyError.extractionFailed(directory, underlying: nil)
    }
}
